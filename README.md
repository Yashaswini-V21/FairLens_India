...
<p>
  <a href="http://localhost:8000"><img src="https://img.shields.io/badge/UI-Frontend-0ea5e9?style=for-the-badge" alt="UI"/></a>
  <a href="http://localhost:8080/health"><img src="https://img.shields.io/badge/API-Backend-16a34a?style=for-the-badge" alt="API"/></a>
  <a href="https://fairlens-india.onrender.com/health"><img src="https://img.shields.io/badge/Cloud-Render-2563eb?style=for-the-badge" alt="Cloud"/></a>
  <a href="https://fastapi.tiangolo.com"><img src="https://img.shields.io/badge/FastAPI-Service-009688?style=for-the-badge&logo=fastapi&logoColor=white" alt="FastAPI"/></a>
  <a href="https://langchain-ai.github.io/langgraph/"><img src="https://img.shields.io/badge/LangGraph-Orchestrator-f97316?style=for-the-badge" alt="LangGraph"/></a>
</p>

<p>
  <img src="https://img.shields.io/badge/Fairness_Target-DPD%20%3C%200.10-22c55e?style=flat-square" alt="KPI 1"/>
  <img src="https://img.shields.io/badge/Explainability_Mode-Gemini%20%2B%20Fallback-0ea5e9?style=flat-square" alt="KPI 2"/>
  <img src="https://img.shields.io/badge/Correction-ExponentiatedGradient-f59e0b?style=flat-square" alt="KPI 3"/>
  <img src="https://img.shields.io/badge/Report_Artifacts-PDF%20%2B%20JSON-a855f7?style=flat-square" alt="KPI 4"/>
</p>
...
|---|---|---|---|
| <img src="https://github.com/Yashaswini-V21.png?size=100" width="62" alt="Yashaswini avatar"/> | Yashaswini V | Leader, Full-Stack and AI Engineer | [Yashaswini-V21](https://github.com/Yashaswini-V21) |
| <img src="https://github.com/DARSHINI-KH.png?size=100" width="62" alt="Darshini avatar"/> | Darshini KH | Core Member, Frontend and Backend Co-Builder | [DARSHINI-KH](https://github.com/DARSHINI-KH) |
...
flowchart LR
  ...
  A1 --> OUT[Audit Output\nmetrics, explanation, correction, report path]
  A2 --> OUT
  A3 --> OUT
  A4 --> OUT
  A5 --> OUT
...
```mermaid
flowchart TD
  S[Start Audit] --> V[Validate model and dataset]
  V --> D[Detect bias]
